...
fobj_densebox_label_train = fopen('densebox-label/train.txt', 'w');
fobj_densebox_label_test  = fopen('densebox-label/test.txt',  'w');
for i = 1 : im_num
    ...
    for j = 1:length(tops)
        ...
        fprintf(fobj_densebox_output, ' 0 0 1 1');
